          ...
          if int(update.from_user.id) == int(user):
            ...
            if "aha.video" in u:
              if "movies" in u:
                ...
                ahareq1 = requests.get("https://prod-api-cached-2.viewlift.com/content/pages?path=" + ahamovpath + "&site=aha-tv&includeContent=true&moduleOffset=0&moduleLimit=5&languageCode=default&countryCode=IN").json().modules.1.settings.contentData.0.gist["id"]
