...
async def inline(bot, inline_query):
    if inline_query.query == "":
       ...
       return
    u = "https://gwapi.zee5.com/content/getContent/search?q=" + inline_query.query.replace(" ", "%20") + "&start=0&limit=24&asset_type=1&country=IN&languages=en,ta&translation=en&version=5&page=1"
